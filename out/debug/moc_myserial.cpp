...
QT_MOC_LITERAL(4, 25, 11) // "on_readData"

    },
    "MySerial\0readyRead\0\0data\0on_readData"
};
...
void MySerial::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MySerial::readyRead)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void MySerial::readyRead(QByteArray _t1)
{
